...
This report documents empirical baseline and agent performance established on `data/gold/gold_eval_200.jsonl`.
...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **AppleSupport AI Agent (T8 - Offline Hybrid)** | **55.00%** | **53.57%** | **59.50%** | **66.67%** | **42.72%** | **52.07%** | **28.44%** | **23.93%** | **23.79%** |
...
- **ROUGE-L F1**: `23.93%`
- **BLEU-1**: `23.79%`
- **Mean Reply Length**: `24.2 words` (124.3 chars) vs Gold: `26.9 words` (140.3 chars)
...
## 4. Trivial Baseline Agent Configuration (Task T6)
